...
TTF_Init();
	//Creating window
	window = SDL_CreateWindow("KillBill", 359, 100, 640, 480, SDL_WINDOW_SHOWN);
                    ...
                    else if( e.type == SDL_KEYDOWN )
                    {
                        ...
                        switch( e.key.keysym.sym )
                        {
                            ...
                            quit = true;
                           	break;
														case SDLK_2:
														MainSc = IMG_Load("hsc.png");
														SDL_BlitSurface( highscreen, NULL, MainSc, &hsrect);
														wrhs();
														strm.str("");
														strm.clear();
                            ...
                            car2rect.x = 222;
                            break;
														//If Ente is pressed, paused game resumes
														case SDLK_RETURN:
                            if(pause == false){
															MainSc = NULL;
															pause = true;
